...
**Current objective: finish BN3 level 3.** That unlocks `WarehouseAPI` and `OfficeAPI` for free
in every other BitNode; without SF3.3 they cost **$50b each in corp funds**. Corporations are the
current focus for that reason.
...
| | |
|---|---|
| BitNode | **BN3**, early, little progress |
| Source-Files | **SF1.3, SF2.3, SF3.2, SF4.3, SF5.1, SF6.1, SF9.1** |
| Existing corporation | one running, **expendable** — dispose before running the round 1 recipe |
| Home RAM | ~32 GB (SF1.3 entry value) — genuinely tight |
