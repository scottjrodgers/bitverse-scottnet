...
// var ASCEND_POWER_THRESHOLD = 15 //Ascend multiplier the gang member should be at before contributing to territory warfare
...
function ascend(ns, mem) {
	...
	let str_mult = ns.formulas.gang.ascensionMultiplier(ns.formulas.gang.ascensionPointsGain(info.str_exp) + info.str_asc_points) - info.str_asc_mult + 1
  ...
  // If the strength ascension multiplier is above 5, ascend the member and set their task back to training.
	if (str_mult > MULTIPLIER_THRESHOLD) {
