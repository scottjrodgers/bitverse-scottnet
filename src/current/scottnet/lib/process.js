...
export const botMap = {
  ...
  "watch": "/scottnet/watch.js",
  "bladeloop": "/scottnet/blades/bladeloop.js",
  "prep-controller": "/scottnet/prep_controller.js",
};
...
export const processMap = {
  ...
  'scottnet/watch.js': 'watch',
  'scottnet/blades/bladeloop.js': 'bladeloop',
  'scottnet/prep_controller.js': 'prep-controller',
}
...
export class BotBatch {
  constructor(ns, botType, numJobs, period, threadsPerJob = 1, delay = 0) {
...
export class BotDeployment {
  ...
  addBatch(ns, botType, numJobs, period, threadsPerJob = 1, delay = 0) {
    const batch = new BotBatch(ns, botType, numJobs, period, threadsPerJob, delay);
...
/** @param {NS} ns */
export async function deploy_job(ns, bot, args = [], n = 1, threads = 1, delay = 0, gap = 0, verbose = false, useHacknet=false) {
  ...
  for (const ramData of servers) {
    ...
    if (!name.startsWith("hacknet") || useHacknet) {
